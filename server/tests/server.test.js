...
const ID_NOT_EXIST = '6ad134a43b18c9382be747e9'
const ID_NOT_VALID = '5ad134a43b18c9382be747e911'
...
describe('GET /todos/:id', () => {
  it('should return todo doc', (done) => {
    request(app).get(`/todos/${todos[0]._id.toHexString()}`).expect((res) => {
  ...
  it('should return 404 for non-object ids', (done) => {
    request(app).get(`/todos/${ID_NOT_VALID}`).expect(404).end(done)
  })
})
